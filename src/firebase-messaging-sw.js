importScripts('https://www.gstatic.com/firebasejs/7.0.0/firebase-app-compat.js');
importScripts('https://www.gstatic.com/firebasejs/7.0.0/firebase-messaging-compat.js');
